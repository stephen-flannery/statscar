export default function StatsRoute() {
    return (
        <div className="h-full w-full flex-1 flex flex-col items-start py-12 max-w-6xl mx-auto">
            ...
            <div className="flex gap-8">
                ...
                <div className="max-w-sm bg-gray-200 rounded-lg shadow-md">
                    ...
                    <div className="p-5">
                        ...
                        <p className="mb-6 font-normal text-gray-600">
                            See how drivers win more or less depending on how
                            many races they have ran in their career.
                        </p>
                        <a
                ...
                <div className="max-w-sm bg-gray-200 rounded-lg shadow-md">
                    ...
                    <div className="p-5">
                        ...
                        <p className="mb-6 font-normal text-gray-600">
                            See how active drivers have finished at Darlington
                ...
                <div className="max-w-sm bg-gray-200 rounded-lg shadow-md">
                    ...
                    <div className="p-5">
                        ...
                        <p className="mb-6 font-normal text-gray-600">
                            See the probability of each playoff driver advancing
                            each round.
                        </p>
                        <a
